package cn.qpwa.common.web.template.method;
...
public class CurrencyMethod implements TemplateMethodModel {
	...
	public Object exec(List arguments) throws TemplateModelException {
		if (arguments != null && !arguments.isEmpty() && arguments.get(0) != null && StringUtils.isNotEmpty(arguments.get(0).toString()) && CommonUtil.isNumber(arguments.get(0).toString())) {
