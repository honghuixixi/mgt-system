...
public class User {
    ...
    /**针对是否为外部用户，店铺/供应商默认为Y，（MGT用户管理：新建用户N）**/
	...
	/**详细地址*/
	private String crmAddress2;
	/**详细地址*/
	private String crmAddress3;
	/**用户头像*/
	...
	@Column(name="CRM_ADDRESS2")
	public String getCrmAddress2() {
		return crmAddress2;
	}

	public void setCrmAddress2(String crmAddress2) {
		this.crmAddress2 = crmAddress2;
	}
	@Column(name="CRM_ADDRESS3")
	public String getCrmAddress3() {
		return crmAddress3;
	}

	public void setCrmAddress3(String crmAddress3) {
		this.crmAddress3 = crmAddress3;
	}

	@Column(name="HEAD_IMG",length=256)
