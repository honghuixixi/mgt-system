    ...
    var jq = (function(window) {
        ...
        */
        ...
        function detectUA($, userAgent) {
            $.os = {};
            $.os.weixin = userAgent.match(/MicroMessenger\/([\d.]+)/) ? true : false;//add by gaiay dubaobing 2013.7.30
            $.os.webkit = userAgent.match(/WebKit\/([\d.]+)/) ? true : false;
            $.os.android = userAgent.match(/(Android)\s+([\d.]+)/) || userAgent.match(/Silk-Accelerated/) ? true : false;
			$.os.androidICS = $.os.android && userAgent.match(/(Android)\s4/) ? true : false;
            $.os.androidNoWebKit = userAgent.match(/(Android)\s+([\d.]+)/) || userAgent.match(/Silk-Accelerated/) ? true : false;
        ...
        $._detectUA = detectUA; //needed for unit tests
...
if(!((window.DocumentTouch&&document instanceof DocumentTouch)||'ontouchstart' in window)){
    var script=document.createElement("script");
    script.src= ctx + "/css/catgen/app/js/jq.desktopBrowsers.js";
