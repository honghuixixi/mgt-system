...
//						alert("OK123");
//						$(pgboxes).empty();
//						$(pgboxes).append("<div id='grid-pager' class='ui-state-default ui-jqgrid-pager ui-corner-bottom' dir='ltr'><div role='group' class='ui-pager-control' id='pg_grid-pager'><table border='0' cellspacing='0' cellpadding='0' role='row' style='width:100%;table-layout:fixed;height:100%;' class='ui-pg-table'><tbody><tr><td align='right' id='grid-pager_right'><div class='ui-paging-info' style='text-align:center;font-size:20px;' dir='ltr'>无数据显示</div></td></tr></tbody></table></div></div>");
...
//						alert("OK456");
		...
		if(ts.p.pager){
			...
			$(ts.p.pager).css({width: "100%"}).appendTo(eg).addClass('ui-state-default ui-jqgrid-pager ui-corner-bottom');
		...
		$(grid.bDiv)
			.append($('<div class="ui-jqgrid-bdivFind" style="position:relative;'+(isMSIE && $.browser.version < 8 ? "height:0.01%;" : "")+'"></div>').append('<div></div>').append(this))
			.addClass("ui-jqgrid-bdiv")
			//.css({ height: ts.p.height+(isNaN(ts.p.height)?"":"px"), width: "1000px"})
