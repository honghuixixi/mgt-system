		...
		lSelect: function(options) {
			...
			return this.each(function() {
				...
				function addSelect($position, parentId, currentId) {
					...
					if(settings.isArea=="ok"){
						var select = '<select class="form-control input-sm isArea" name="' + selectName + '">';
					}else{
						var select = '<select class="form-control input-sm" name="' + selectName + '">';
					}
