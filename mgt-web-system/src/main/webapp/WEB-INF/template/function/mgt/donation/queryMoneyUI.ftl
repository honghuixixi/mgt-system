			...
			<form class="form-horizontal" id="form"  method="POST">
 	        <div class="page-content">
	 	        <div class="page-contentList clearfix">
	 	       	...
	 	       	<div class="page-contentList clearfix">
	 	       		<div class="page-contentList1" style="width:158px;"><label>订单金额 >=:</label></div>
	 	        	<div class="page-contentList2" style="width:150px;"><input type="text" id="beginAmount" name="beginAmount" class="form-control required number" style="width:100px;" maxlength='8'/></div>
	 	        	<div class="page-contentList1" style="width:50px;"><label style="width:50px;"><=:</label></div>
	 	        	<div class="page-contentList2" style="width:150px;"><input type="text"  id="endAmount" name="endAmount" class="form-control required number" style="width:100px;" maxlength='8'/></div>
	 	       	</div>
    ...
    if (mgt_util.validate(form)){
    	var beginDate =$("#beginDate").val();
   		...
   		if(Number(beginAmount) > Number(endAmount)){
            top.$.jBox.tip('提示金额输入有误，请重新输入!');
            $("#beginAmount").val("");
   			$("#endAmount").val("");
			return;
        }
   		//alert(window.parent.getids())
   		var type =$("input[name='type']:checked ").val();
   		var page ="beginDate="+beginDate+"&endDate="+endDate+"&beginAmount="+beginAmount+"&endAmount="+endAmount+"&type="+type+"&flg=S&userids="+window.parent.getids()
   		//var page ="{beginDate:'"+beginDate+"',endDate:'"+endDate+"',beginAmount:'"+beginAmount+"',endAmount:'"+endAmount+"',type:'"+type+"',flg:'S'}"
   		var condition = "日期从"+beginDate+",到"+endDate+" 订单金额>="+beginAmount+" 且 订单金额<="+endAmount;
   		...
   		window.parent.document.getElementById("beginAmount").value=beginAmount;
   		window.parent.document.getElementById("endAmount").value=endAmount;
