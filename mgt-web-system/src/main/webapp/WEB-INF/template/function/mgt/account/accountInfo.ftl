			...
			$(document).ready(function(){
				mgt_util.jqGrid('#grid-table',{
					url:'${base}/account/accountinfoList.jhtml',
 					colNames:['ID','用户名','供应商名称','用户类型','状态','供应商地址','联系人','联系电话'],
				   	colModel:[
       ...
       <div class="body-container">
			...
			<div id="currentDataDiv" action="menu">
                <div class="currentDataDiv_tit">
					<button type="button" class="btn btn-info btn_divBtn" id="account_join" data-toggle="jBox-audit-userfunction" href="${base}/account/synchAccount.jhtml">供应商入驻</button>
				</div>
                ...
                <div class="search_cBox">
	                <div class="form-group">
	                 	<button type="button" class="search_cBox_btn" id="account_search" data-toggle="jBox-query"><i class="icon-search"></i> 搜 索 </button>
	                </div>
                </div>
	        </div>
	      </div>
