 ...
 $(document).ready(function(){
   ...
   //ajax 实现文件上传 
	...
	<body class="toolbar-fixed-top">
		<form class="form-horizontal" id="form" action="${base}/b2cPromMas/editB2cPromMas.jhtml" method="POST">
			<input type="hidden" id="pkNo" name="pkNo"  value="${prom.pkNo}" >
 			<input type="hidden" name="fullPath" id="fullPath" value='${prom.thumbnail}'/>
 	        ...
 	        <div class="row">
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
		                    	<input type="text" id="promCode" name="promCode" class="form-control required" value="${prom.promCode}"/> 
							</div>
						</div>
					</div>
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
		      					<input  type="radio"  style="margin-bottom:2px;height:30px;width:40px;" name="noCarts" value="N" [#if prom.noCarts=='N']checked="checked"[/#if]><span style="height:30px;width:40px;">否</span>
							    <input  type="radio"  style="margin-bottom:2px;height:30px;width:40px;" name="noCarts" value="Y" [#if prom.noCarts=='Y']checked="checked"[/#if]><span style="height:30px;width:40px;">是</span>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
		                    <input type="text" id="dateFrom" name="dateFrom" class="form-control required" value="${prom.dateFrom?string("yyyy-MM-dd")}" readonly=true /> 
							</div>
						</div>
					</div>
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
		      				<input type="text" id="dateTo" name="dateTo" class="form-control required "  value="${prom.dateTo?string("yyyy-MM-dd")}"   readonly=true  />
							</div>
						</div>
					</div>
				</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<select class="form-control input-sm required" id="couponFlg" name="couponFlg" style="width:200px;" >
										<option value="P" [#if prom.couponFlg=='P']selected = "selected"[/#if]>网站平台</option>
										<option value="V" [#if prom.couponFlg=='V']selected = "selected"[/#if]>供应商</option>
									</select>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-xs-5">
						<div class="form-group">
						    ...
						    <div class="col-sm-7">
					            <img id="imgsrc" name="imgsrc" src="${prom.thumbnail}" hight="40px" width="80px"/>
	 			...
	 			<div class="row">
					<div class="col-xs-5">
						<div class="form-group">
						    ...
						    <div class="col-sm-7">
					            <textarea class="form-control" style="width: 531px; height: 164px;" name="note" id="note" maxlength=300>${prom.note}</textarea>
						    </div>
						</div>
					</div>
				</div>
