		...
		<script  type="text/javascript">
			$(document).ready(function(){
					...
					mgt_util.jqGrid('#grid-table',{
						...
						url:'${base}/order/salerStatisticsList.jhtml',
	 					colNames:['姓名','工号','订单量','订单总金额','完成订单量','完成订单总金额','未完成订单量','未完成订单总金额'],
					   	colModel:[
					   		{name:'SP_NAME',align:"center",width:200},
					   		{name:'USER_NAME_S',align:"center",width:200},
					   		{name:'TOTAL',align:"center",width:150},
					   		{name:'AMOUNT',align:"center",width:150},
					   		{name:'SUCCESS',width:150,align:'center'},
					   		{name:'SUCCESS_AMOUNT',width:150,align:'center'},
					   		{name:'WEI',width:150,align:'center'},
					   		{name:'WEI_AMOUNT',width:150,align:'center'} 
					   	],
					...
					$("#exportExcel").click(function(){
			            ...
			            window.location.href = "${base}/order/salerStatisticsExportExcel.jhtml?cols="+cols+
			            		"&colNames="+encodeURI(colNames)+"&startDate="+startDate+"&endDate="+endDate;
					});
					$("#exportMasDetail").click(function(){
						var startDate = $("input[name='startDate']").val();
				        var endDate = $("input[name='endDate']").val();
				        window.location.href = "${base}/order/salerStatisticsMasDetailExportExcel.jhtml?startDate="+startDate+"&endDate="+endDate;
					});
				});
	            ...
	            <form class="form form-inline queryForm"  id="query-form" name="form1">
	                 ...
	                 <div class="form-group">
						...
						<div class="search_cBox" style="bottom:20px;">
						        ...
						        <button type="button" class="btn_divBtn" id="exportMasDetail">导出商品汇总明细 </button>
