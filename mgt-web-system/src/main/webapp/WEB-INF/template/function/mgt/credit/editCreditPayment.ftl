...
<html>
	...
	<input type="hidden"  id="oldcatc"  name="oldcatc" value="${id}" >
	<body class="toolbar-fixed-top">
		<form class="form-horizontal" id="form" action="${base}/credit/updateCreditPayment.jhtml">
		<input type="hidden"  id="id"  name="id" value="${creditPayment.id}" >
		<input type="hidden"  id="accountName"  name="accountName" value="${creditPayment.accountName}" >
			...
			<div class="page-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required " id="userName" maxlength=16
									name="userName" value="${creditPayment.userName}" >
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required " id="deliverMobile" maxlength=16
									name="deliverMobile" value="${creditPayment.deliverMobile}" >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required " id="creditMaximum" maxlength=30
									name="creditMaximum" value="${creditPayment.creditMaximum}" >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-7">
					            <input type="text" class="form-control input-sm required " id="creditCurrent" maxlength=30
									name="creditCurrent" value="${creditPayment.creditCurrent}" >
						    </div>
						    <span class="help-inline col-sm-1">*</span>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required " id="cREDIT_TERM" maxlength=30
									name="cREDIT_TERM" value="${creditPayment.cREDIT_TERM}" >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required " id="guarantee" maxlength=30
									name="guarantee" value="${creditPayment.guarantee}" >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
				...
				<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required " id="guarantee" maxlength=30
									name="deposit" value="${creditPayment.deposit}" >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
				...
				<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required " id="guarantee" maxlength=30
									name="conthlyIncome" value="${creditPayment.conthlyIncome}" >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required " id="createBy" maxlength=30
									name="createBy" value="${creditPayment.createBy}" >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-7">
					            <input type="text" class="form-control input-sm required" id="createDate" maxlength=30
									name="createDate" value="${creditPayment.createDate}" >
						    </div>
						    <span class="help-inline col-sm-1">*</span>
						</div>
					</div>
