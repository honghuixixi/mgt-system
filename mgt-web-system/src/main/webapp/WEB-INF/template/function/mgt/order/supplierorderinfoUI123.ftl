			...
			<div id="currentDataDiv" action="menu" >
	            <form class="form form-inline queryForm" style=" overflow:hidden;" id="query-form"> 
					...
					<div class="currentDataDiv_tit">
						...
						<label class="radio"><input class="btn_divBtn" type="radio" name="sub_status_radio" value="WAITPRINT" > 待打印</label>
						<label class="radio"><input class="btn_divBtn" type="radio" name="sub_status_radio" value="WAITDELIVER" > 待发货</label>
