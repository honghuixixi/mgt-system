...
<html>
	...
	<body class="toolbar-fixed-top">
		<form class="form-horizontal" id="form"
			action="${base}/resource/add.jhtml">
				...
				<div class="row">
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required" name="name" maxlength=30>
							</div>
		            ...
		            <div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
							    <input id="citySelsss" name="citySel" type="text" class="form-control required" readonly value="" onclick="Yhxutil.ztree.showMenu(this);" />
								<input id="citySelCodess" name="citySelCode" type="hidden" value="" />
						    </div>
						    <span class="help-inline col-sm-1">*</span>
					    </div>
				    </div>
				...
				<div class="row">
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required" name="value" maxlength=30 >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required" name="url" maxlength=300 >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm number required" name="orderby" maxlength=5>
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
