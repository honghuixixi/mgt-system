		...
		<script language="javascript" type="text/javascript">
			$(document).ready(function(){
				$('#file').live('change',function(){
					...
					$.ajaxFileUpload({
						url : "${base}/upload/excelUpload.jhtml?type=stkmas",
						secureuri : false,
						data : {
							filePre : "feedback",
							p : new Date()
						...
						success : function(data) {
							if(data.status == "success"){
								top.$.jBox.tip('导入完成，请返回列表页，刷新页面！','sucess');
							}else{
	...
	<body>
		<div class="spdr_Box">
		    ...
		    <div class="spdr_cont2">
		    	<span class="spdr_cont2_bg1"><i></i><br />下载模板</span><font></font><span class="spdr_cont2_bg2"><i></i><br />填写商品内容</span><font></font><span class="spdr_cont2_bg3"><i></i><br />导入EXCEL</span><font></font><span class="spdr_cont2_bg4"><i></i><br />导入图片</span><font></font><span class="spdr_cont2_bg5"><i></i><br />检查</span><font></font><span class="spdr_cont2_bg6"><i></i><br />导入系统</span>
		    </div>
		    <div class="spdr_cont3"><i></i>特别提醒：<span>1. 必须按照要求填写EXCEL</span><span>2. 商品图片以条码+-1、-2构成</span></div>
		    <div class="spdr_cont1Tit spdr_cont4">导入步骤</div>
		    <div class="spdr_cont5 clearfix">
		    	<div class="spdr_cont5_1"><span>1</span><i></i><a href="${base}/impstkmas/exportExcelTemplate.jhtml">EXCEL模板下载</a></div>
