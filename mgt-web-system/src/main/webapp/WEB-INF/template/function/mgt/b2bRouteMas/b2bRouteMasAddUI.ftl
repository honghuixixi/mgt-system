...
<html>
	...
	<body class="toolbar-fixed-top">
		<form class="form-horizontal" id="form"  method="post"  action="${base}/b2bRouteMas/add.jhtml">
		<input type="hidden"  id="logisticCode"  name="logisticCode" value="${accountName}">
