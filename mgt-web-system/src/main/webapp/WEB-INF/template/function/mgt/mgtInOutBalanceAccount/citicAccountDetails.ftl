		...
		<script type="text/javascript">
			$(document).ready(function(){
				mgt_util.jqGrid('#grid-table',{
					multiselect:false,
					url:'${base}/inOutBalanceOfAcc/citicAccountDetailList.jhtml',
 					colNames:['','交易日期','类型','客户编号','客户名称','交易号','方向','交易金额','余额','对方银行帐号','对方帐户','备注'],
				   	colModel:[
			...
			<div id="currentDataDiv" action="menu" >
				<div class="control-group sub_status">
					<ul class="nav nav-pills" role="tablist">
						...
						<li role="presentation" id="citicAccountDetails" class="sub_status_but active"><a>中信账户明细</a></li>
					</ul>
				 </div>
				 <div   style="border-bottom:1px solid #f39801;padding-bottom:10px;position:relative;">
					 <form class="form form-inline" id="basic-query">
		           		<div>
		                 ...
		                 <div class="form-group">
							...
							<input type="text" class="form-control" id="startDate" style="width:90px;" name="startDate" onfocus="WdatePicker({maxDate:$('#endDate').val(),dateFmt:'yyyy-MM-dd',onpicked: findFormTimes(4)});"  >
						</div>
						<div class="form-group">
							<label class="control-label" style=" vertical-align: middle;">至</label>
							<input type="text" class="form-control" id="endDate" style="width:90px;" name="endDate" onfocus="WdatePicker({minDate:$('#startDate').val(),dateFmt:'yyyy-MM-dd',onpicked: findFormTimes(4)});">
						</div>
	            ...
	            <div class="form_divBox" >
		            <form class="form form-inline queryForm" style=" overflow:hidden;" id="query-form" method="post" action="${base}/inOutBalanceOfAcc/citicAccountDetailList.jhtml"> 
						...
						<div class="form-group">
		                    <label class="control-label" style=" vertical-align: middle;">客户编号</label>
		                    <input type="text" class="form-control" placeholder="请输入客户编号" name="custId" id="custId" style="width:120px;" >
		                </div>
		                <div class="form-group">
		                    <label class="control-label" style=" vertical-align: middle;">客户名称</label>
...
<script type="text/javascript">
	...
	function findFormTimes(obj){
		...
		$('#startDate').val(jsonParams['startDate']);
		$('#endDate').val(jsonParams['endDate']);
		$("#grid-table").jqGrid('setGridParam',{  
	        datatype:'json',  
