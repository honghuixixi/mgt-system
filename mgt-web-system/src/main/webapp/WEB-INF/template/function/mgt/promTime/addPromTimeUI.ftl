...
<html>
	...
	<body style="padding:20px 20px 0 20px;">
		<form class="form-horizontal" id="form" action="${base}/prom/savePromTime.jhtml" method="POST">
			...
			<input type="hidden" name="payOnlineFlg" value="N"/>
			...
			<table class="promTimeUl-table" width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<td width="35%">
					<select name="masCode" class="form-control required" style="width:150px;">
						<option value="WEBPROMD">限时抢购</option>
					</select>
					<span class="help-inline">*</span>
				</td>
				<td width="15%" align="right"><label for="refNo" class="control-label">活动名称：</label></td>
				<td width="35%">
					<input type="text" id="refNo" name="refNo" class="form-control required" onblur="checkLength(this);" style="width:200px;" /> 
					<span class="help-inline">*</span>
				</td>
			  </tr>
			  <tr>
				...
				<td>
					<input type="text" id="beginDate" name="beginDate" class="form-control required" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width:100px;" /> 
					<input type="text" id="endDate" name="endDate" class="form-control required"   onClick="WdatePicker({minDate:'#F{$dp.$D(\'beginDate\')}',dateFmt:'yyyy-MM-dd'})" style="width:100px;" />
					<span class="help-inline">*</span>
				</td>
				<td align="right"><label for="timeFrom" class="control-label">时间段：</label></td>
				<td>
					<input type="text" id="timeFrom" name="timeFrom" onblur="checkTimeFrom(this);" class="form-control required" style="width:100px;" />
					<input type="text" id="timeTo" name="timeTo" onblur="checkTimeTo(this);" class="form-control required" style="width:100px;" />
					<span class="help-inline">*</span>
				</td>
			  </tr>
			  <tr>
				...
				<td>
					<input style="width:200px;" type="text" id="minAmtNeed" name="minAmtNeed" onblur="checkNumber(this);" class="form-control required" />
					<span class="help-inline">*</span>
				</td>
				<td colspan="2"><input style="float:left;margin:0 5px 0 0" type="checkbox" class="search_cBox_btn" id="payOnlineFlg"/> <label class="control-label">抢购活动必须使用在线支付</label></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td colspan="3">
					<textarea class="form-control" style="width: 531px; height: 80px;" name="spNote" id="spNote" maxlength=300></textarea>
				</td>
			  </tr>
			</table>
