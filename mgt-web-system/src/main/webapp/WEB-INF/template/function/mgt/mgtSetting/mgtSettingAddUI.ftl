...
<html>
		...
		<script language="javascript" type="text/javascript">
			$(document).ready(function(){
				$('#defFlg').change(function(){
					if(jQuery("#defFlg  option:selected").val() == 'N'){
	...
	<body class="toolbar-fixed-top">
		<form class="form-horizontal" id="form"
			action="${base}/mgtSetting/mgtSettingAdd.jhtml">
				...
				<div class="row">
		            <div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
							    <input id="citySelsss" name="menuName" type="text" class="form-control required" readonly value="" onclick="Yhxutil.ztree.showMenu(this);" />
								<input id="citySelCodess" name="menuId" type="hidden" value="" />
						    </div>
				    ...
				    <div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required" name="description" maxlength=30 >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
				...
				<div class="row">
		            <div class="col-xs-5" id="defValue" hidden="true">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm number " name="defValue" maxlength=5>
							</div>
						</div>
					</div>
				</div>
