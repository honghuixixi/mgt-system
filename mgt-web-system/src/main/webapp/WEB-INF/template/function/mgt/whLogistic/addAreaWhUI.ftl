...
<html>
	...
	<body class="toolbar-fixed-top">
		<form class="form-horizontal" id="form" action="${base}/warehouse/save.jhtml">
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input style="margin:0;padding:0;" type="text" class="form-control input-sm required addRoleByName" id="whC" maxlength=30 name="whC" value="" >
							</div>
					...
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input style="margin:0;" type="text" class="form-control input-sm required addRoleByName" id="name" maxlength=30
									name="name" value="" >
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
				...
				<div class="row">
					...
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
	                    		<select data-placeholder="请选择仓库属性" disabled="true" class="form-control" name="owner" id="owner">
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<textarea class="form-control input-sm required addRoleByName" id="address1" name="address1"></textarea>
							</div>
							<span class="help-inline col-sm-1">*</span>
						</div>
					</div>
