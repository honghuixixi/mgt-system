...
<html>
	...
	<body class="toolbar-fixed-top">
		<form class="form-horizontal" id="form"
			action="${base}/category/add.jhtml">
				...
				<div class="row">
					<div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control input-sm required" name="catName" maxlength=30>
							</div>
		            ...
		            <div class="col-xs-5">
						<div class="form-group">
							...
							<div class="col-sm-7">
							    <input id="citySelsss" name="citySel" type="text" class="form-control " readonly value="" onclick="Yhxutil.ztree.showMenu(this);" />
...
var param = {
  url:'${base}/category/categoryList.jhtml',
  data:datas,
  //true 多选   false 单选
  MultiCheck:false,
