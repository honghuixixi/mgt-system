...
<html>
	...
	<body class="toolbar-fixed-top">
		<form class="form-horizontal" id="form"  method="post"  action="${base}/impstkmas/updatevendorcat.jhtml">
				...
				<div class="row">
					<div class="col-xs-9">
						<div class="form-group">
						    <label for="status" class="col-sm-4 control-label">商家类别：</label>
							<div class="col-sm-3">
								<select class="form-control input-sm required" id="catC" name="catC" >
