			...
			function orderUpdate(){
				...
				if(ids.length>0){
					mgt_util.showjBox({
						...
						height : 500,
						title : '分配',
						url : '${base}/logistics/logisticUser.jhtml?ids='+ids,
						grid : '#grid-table'
					});
				}else{
          ...
          <div class="main_heightBox1">
			<div id="currentDataDiv" action="menu" >
				...
				<div class="currentDataDiv_tit">
					<button type="button" class="btn_divBtn"  onclick="orderUpdate()" ><i class="btn_info_icon btn_icon1"></i>分配订单 </button>
