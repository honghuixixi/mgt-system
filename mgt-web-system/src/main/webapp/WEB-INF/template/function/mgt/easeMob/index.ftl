            ...
            <table>
                <tr>
                    <td width="65%">
                        ...
                        <input type="text" name="username" value="${mgtEmployee.accountName}" id="username" tabindex="1"/>
                        <label for="password">密码:</label>
                        <input type="password" name="password" value="123" id="password" tabindex="2" />
...
<div id="waitLoginmodal" class="modal hide" data-backdrop="static">
    ...
    <div class="content" id="content" style="display: none;width:700px;align:center;">
        <div class="leftcontact" id="leftcontact" style="margin-left:0px;margin-top:10px;height:500px;">
            <div id="headerimg" class="leftheader">
                <span> <img src="${base}/styles/css/web-im/img/head/header2.jpg" alt="logo"
                    class="img-circle" width="40px" height="40px"
                    style="margin-top: -10px; margin-left: 0px" />
                </span>
                <span
                    id="login_user" class="login_user_title" style="width:80px;"> 
            ...
            <div id="contractlist11"
                style="height: 457px; overflow-y: auto; overflow-x: auto;">
                <div class="accordion" id="accordionDiv">
                    <div class="accordion-group">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in">
                            <div class="accordion-inner" id="contractlist" style="height:290px;">
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="collapseTwo" class="accordion-body collapse">
                            <div class="accordion-inner" id="contracgrouplist" style="height:290px;">
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="collapseThree" class="accordion-body collapse">
                            <div class="accordion-inner" id="momogrouplist" style="height:290px;">
					...
					<div id='em-cr' class="accordion-group">
                        ...
                        <div id="collapseFour" class="accordion-body collapse">
                            <div class="accordion-inner" id="chatRoomList" style="height:290px;">
        ...
        <!-- 聊天页面 -->
        <div class="chatRight" style="margin-left:200px;margin-top:-70px;width:498px;height:502px;">
            <div id="chat01">
                <div class="chat01_title">
                    <ul class="talkTo">
                        <li id="talkTo"><a href="#"></a></li>
                        <li id="recycle" style="float: right;"><img
                            src="${base}/styles/css/web-im/img/recycle.png" onclick="clearCurrentChat();"
                            style="margin-right: 15px; cursor: hand; width: 18px;" title="清屏" /></li>
                        <li id="roomInfo" style="float: right;"><img
                            id="roomMemberImg"
                            src="${base}/styles/css/web-im/img/head/find_more_friend_addfriend_icon.png"
            ...
            <div class="chat02">
                ...
                <div id="input_content" class="chat02_content">
                    <textarea id="talkInputId" style="resize: none;width:489px;height:61px;"></textarea>
                </div>
                <div class="chat02_bar">
                    <ul>
                        <li style="right: 5px; top: 5px;"><img src="${base}/styles/css/web-im/img/send_btn.jpg"
                            onclick="sendText()" /></li>
                    </ul>
                </div>
